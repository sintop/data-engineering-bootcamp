...
GCS_BUCKET = "sintop-100037"
BIGQUERY_DATASET = "networkrail"
KEYFILE = "/opt/airflow/dags/kinetic-genre-384501-9d633532a56c.json"
...
with DAG(
    ...
    load_data_from_gcs_to_bigquery = PythonOperator(task_id="load_data_from_gcs_to_bigquery",python_callable=_load_data_from_gcs_to_bigquery)
